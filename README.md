...
- Node JS
- NPM
- Packages: inquirer, yargs, jest

How to use
------------
- Prompt mode:
  - node src/main.js start
  - node src/main.js start -p

- File text mode:
  - node src/main.js start -f scr/tests/exampleA.txt
  - node src/main.js start -f scr/tests/exampleB.txt
  - node src/main.js start -f scr/tests/exampleC.txt